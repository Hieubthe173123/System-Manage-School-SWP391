...
public class AddMenu extends BaseRBACController {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response, Account account)
        ...
        if ("1".equals(save) && !listMenuFood.isEmpty() && age != null) {
    ...
    private void saveMenu(List<MenuFood> listMenuFood, String age, String currentDate, List<MealTime> listMeal, MenuDBContext menuDB, HttpSession session, HttpServletRequest request, HttpServletResponse respond) {
