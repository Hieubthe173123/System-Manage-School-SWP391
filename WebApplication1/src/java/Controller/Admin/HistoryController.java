...
public class HistoryController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<SchoolYear> listYear = sy.getAllSchoolYear();
        List<Lecturers_Class_Session> listLec = lcs.getHistoryAllLecturer(yid);
        request.setAttribute("lec", listLec);
        request.setAttribute("year", listYear);
        request.getRequestDispatcher("FE_Admin/HistoryLecturer.jsp").forward(request, response);
    } 
