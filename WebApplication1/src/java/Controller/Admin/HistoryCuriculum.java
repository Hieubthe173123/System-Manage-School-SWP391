 ...
 * @author admin
 */
@WebServlet(name="HistoryCuriculum", urlPatterns={"/history-curiculum"})
public class HistoryCuriculum extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Curiculum> list = cur.getAllActivityHistory(sid, sdid);
        request.setAttribute("list1", list1);
        request.setAttribute("list",list);
        request.getRequestDispatcher("FE_Admin/HistoryCuriculum.jsp").forward(request, response);
    } 
