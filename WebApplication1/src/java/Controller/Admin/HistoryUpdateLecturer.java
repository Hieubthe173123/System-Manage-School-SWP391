 ...
 * @author admin
 */
@WebServlet(name="HistoryUpdateLecturer", urlPatterns={"/history-update-lecturers"})
public class HistoryUpdateLecturer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Lecturers_Class_Session> list1 = lcs.getHistoryAllLecturerUpdate(lid, yid);
        request.setAttribute("lec", list);
        request.setAttribute("history",list1);
        request.getRequestDispatcher("FE_Admin/HistoryUpdateLecturer.jsp").forward(request, response);
