 ...
 * @author hidung
 */
@WebServlet(name="HomeAdmin", urlPatterns={"/admin"})
public class HomeAdmin extends HttpServlet {
private AccountDBContext accountDB;

    @Override
    public void init() throws ServletException {
        // Initialize the AccountDBContext and the database connection
        accountDB = new AccountDBContext();
        // Assuming there's a method to set the connection
        // accountDB.setConnection(yourDatabaseConnection);
    }
    /**
