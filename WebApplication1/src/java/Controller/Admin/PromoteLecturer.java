 ...
 * @author admin
 */
@WebServlet(name = "PromoteLecturer", urlPatterns = {"/promote-lecturer"})
public class PromoteLecturer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Lecturers> lec = ldb.getAllLecturers();
        request.setAttribute("lec", lec);
        request.getRequestDispatcher("FE_Admin/PromoteLecturer.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       lcs.promoteLecturer(lid, classID);
