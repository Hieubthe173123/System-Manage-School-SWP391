 ...
 */
@WebServlet(name="ChangePassLecturers", urlPatterns={"/lecturers/changepass"})
public class ChangePassLecturers extends BaseRBACController {
   

    protected void processRequest(HttpServletRequest request, HttpServletResponse response, Account account)
    throws ServletException, IOException {
          request.getRequestDispatcher("/FE_Lecturers/ChangePassLecturers.jsp").forward(request, response);
    }
   ...
   @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response, Account account)
        ...
        if (oldPass == null || !oldPass.equals(ac.getPassword())) {
            ...
            acc.changePassLecurers(ac.getLid().getLid(), newPass);
