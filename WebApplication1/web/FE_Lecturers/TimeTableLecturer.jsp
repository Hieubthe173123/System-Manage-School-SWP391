...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(to right, skyblue 0%, skyblue 100%);
            margin: 0;
            padding: 0;
            color: #333;
        }
...
<body>
    ...
    <h2 style="text-align: center">Lecturer Time Table</h1>
    ...
    <div style="text-align: center">
        ...
        <form action="feedback" method="GET">
            <button>Đánh giá buổi học hôm nay</button>
        </form>
    </div>
    <hr/>
